#!/usr/bin/env python3
"""
Check Yosemite Valley campground availability for April 17-19, 2026
...
TARGET_DATES = ["2026-04-17T00:00:00Z", "2026-04-18T00:00:00Z", "2026-04-19T00:00:00Z"]
...
def main():
    ...
    print("Checking Yosemite Valley campground availability for April 17-19, 2026")
    print("=" * 70)
    ...
    for cid in CAMPGROUND_IDS:
        ...
        try:
            ...
            for site_id, site_data in data.get('campsites', {}).items():
                ...
                # Check if all target dates are Available
            ...
            if count > 0:
                ...
                print(f"  ✓ {count} site(s) available for all 3 nights")
            else:
                print(f"  ✗ No sites available for all 3 nights")
