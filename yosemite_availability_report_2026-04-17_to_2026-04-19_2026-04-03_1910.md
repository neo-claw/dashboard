...
**Check Date:** Friday, April 3rd, 2026 — 7:10 PM UTC *(cron job #4315496e-bf9a-4716-85a2-d09cc09351c0)*
...
| 232448 | Tuolumne Meadows Campground | Tioga Road (high elevation) | ✗ No availability | 0 | 289 |
...
**Nearby in Yosemite:**
- Hodgdon Meadow (1393)
- Crane Flat (232449) - Note: ID conflicts, verify
...
Availability data retrieved via Recreation.gov API (using recreation-gov-campsite-checker) on 2026-04-03 at 19:10 UTC. All campgrounds returned zero available sites for the full date range.
